...
const Register = () => {
  ...
  const postDetails = (pics) => {
    ...
    if (pics.type === "image/jpeg" || pics.type === "image/png") {
      ...
      data.append("upload_preset", "HelloChatApp");
      data.append("cloud_name", "dluhozrjr");
      fetch("https://api.cloudinary.com/v1_1/dluhozrjr/image/upload", {
        method: "post",
        body: data,
      })
        .then((res) => res.json())
